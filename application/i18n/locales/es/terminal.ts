...
export const esTerminalMessages: Messages = {
  ...
  'terminal.toolbar.leaveShare': 'Salir de la sesión compartida',
  'terminal.toolbar.startShare': 'Iniciar uso compartido',
  'terminal.toolbar.stopShare': 'Detener uso compartido',
  'terminal.toolbar.sharePin': 'PIN de uso compartido {pin}',
  'terminal.toolbar.copiedPin': 'PIN copiado',
  'terminal.toolbar.shareFrom': 'Compartir por {name}',
  'terminal.share.starting': 'Iniciando uso compartido…',
  'terminal.share.started': 'Uso compartido iniciado. PIN {pin}',
  'terminal.share.stopped': 'Uso compartido detenido.',
  'terminal.share.ended': 'La sesión compartida ha terminado.',
  'terminal.share.startFailed': 'No se pudo iniciar el uso compartido.',
  'terminal.share.joinFailed': 'No se pudo unir a la sesión compartida.',
  'terminal.share.copyFailed': 'No se pudo copiar el PIN.',
  'terminal.share.fileTransferUnsupported': 'La transferencia de archivos no es compatible en el modo de retransmisión.',
  'terminal.share.guestWriteBlocked': 'Los invitados solo pueden usar el terminal compartido.',
  'terminal.share.sizeTitle': 'Tamaño del terminal compartido',
  'terminal.share.ptySize': 'PTY {cols}×{rows}',
  'terminal.share.sizeFromSelf': 'Usando tu tamaño más pequeño',
  'terminal.share.sizeFromPeer': 'Usando el tamaño más pequeño de la otra parte',
  'terminal.share.sizeFromMixed': 'Usando el tamaño más pequeño en cada eje',
  'terminal.share.sizeMatched': 'Ambos coinciden {cols}×{rows}',
  'terminal.share.selfCapacity': 'Esta ventana {cols}×{rows}',
  'terminal.share.peerCapacity': 'La otra parte {cols}×{rows}',
  'terminal.share.scaleToFit': 'Escalar para llenar la ventana',
