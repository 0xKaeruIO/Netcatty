...
export const ruCoreMessages: Messages = {
  ...
  'settings.orgCenter.title': 'Центр организации',
  'settings.orgCenter.hint': 'Добавьте Netcatty Center по адресу и API-ключу. Хосты, пароли и ключи из каталога появятся в хранилище и будут доступны одним щелчком.',
  'settings.orgCenter.url': 'Адрес центра',
  'settings.orgCenter.urlPlaceholder': 'http://10.0.0.1:4780',
  'settings.orgCenter.apiKey': 'API-ключ',
  'settings.orgCenter.apiKeyPlaceholder': 'ncc_...',
  'settings.orgCenter.add': 'Добавить центр',
  'settings.orgCenter.adding': 'Добавление...',
  'settings.orgCenter.sync': 'Синхронизировать',
  'settings.orgCenter.syncing': 'Синхронизация...',
  'settings.orgCenter.remove': 'Удалить',
  'settings.orgCenter.removeConfirm': 'Удалить «{name}» и его хосты каталога с этого устройства?',
  'settings.orgCenter.empty': 'Центр организации ещё не добавлен.',
  'settings.orgCenter.lastSynced': 'Последняя синхронизация: {time}',
  'settings.orgCenter.neverSynced': 'Ещё не синхронизировано',
  'settings.orgCenter.added': 'Добавлен {name}',
  'settings.orgCenter.synced': 'Синхронизирован {name}',
  'settings.orgCenter.removed': 'Удалён {name}',
  'settings.orgCenter.error.duplicate': 'Этот центр организации уже добавлен.',
  'settings.orgCenter.error.urlRequired': 'Укажите адрес центра организации.',
  'settings.orgCenter.error.urlInvalid': 'Недействительный адрес центра организации.',
  'settings.orgCenter.error.urlProtocol': 'Адрес центра организации должен быть http или https.',
  'settings.orgCenter.error.apiKey': 'Недействительный API-ключ центра организации.',
  'settings.orgCenter.error.timeout': 'Истекло время ожидания центра организации.',
  'settings.orgCenter.error.catalog': 'Центр организации вернул неподдерживаемый каталог.',
  'settings.orgCenter.error.bridge': 'Центр организации недоступен в этом окне.',
  'settings.orgCenter.error.generic': 'Не удалось связаться с центром организации.',
  'vault.hosts.orgCenter': 'орг',
