...
export const ruVaultMessages: Messages = {
  ...
  'vault.hosts.openSftp': 'Открыть SFTP',
  ...
  'vault.hosts.orgCenterSync': 'Синхр.',
  'vault.hosts.orgCenterSyncFrom': 'Загрузить из {name}',
  'vault.hosts.orgCenterEmpty': 'Центр организации ещё не добавлен.',
  'vault.hosts.orgCenterOpenSettings': 'Добавить в настройках',
  'vault.hosts.joinShare': 'Войти в общий доступ',
  'vault.hosts.joinSharePin': '6-значный PIN',
  'vault.hosts.joinSharePinInvalid': 'Введите 6-значный PIN общего доступа.',
  'vault.hosts.joinShareSubmit': 'Войти',
  ...
  'pf.action.startAll': 'Запустить все',
  'pf.action.stopAll': 'Остановить все',
  'pf.toast.startAll.success': 'Запущено правил: {count}',
  'pf.toast.startAll.partial': 'Запущено правил: {started} (не удалось: {failed})',
  'pf.toast.startAll.failed': 'Не удалось запустить правил: {count}',
  'pf.toast.stopAll.success': 'Остановлено туннелей: {count}',
  'pf.toast.stopAll.partial': 'Остановлено туннелей: {stopped} (не удалось: {failed})',
  'pf.toast.stopAll.failed': 'Не удалось остановить туннелей: {count}',
  ...
  'sftp.bookmark.removeConfirm': 'Удалить закладку {path}?',
  ...
  'sftp.listDensity.compact': 'Компактный список',
  'sftp.listDensity.comfortable': 'Обычный список',
  'sftp.listDensity.switchToCompact': 'Переключиться на компактный список',
  'sftp.listDensity.switchToComfortable': 'Переключиться на обычный список',
  ...
  'hostDetails.os.title': 'Операционная система',
  'hostDetails.os.desc': 'Используется для сведений о среде и адаптации командной оболочки.',
  ...
  'hostDetails.startupCommand.runMode.help': 'Выберите, как отправлять команды запуска после подключения. Режим правил отправляет текст при появлении приглашения.',
  ...
  'hostDetails.startupCommand.runMode.rules': 'Режим правил',
  'hostDetails.startupCommand.rules.help': 'Когда появляется текст приглашения, отправляется команда. Пустое приглашение отправляет сразу. Несколько правил позволяют переходить по хостам.',
  'hostDetails.startupCommand.rules.step': 'Шаг {n}',
  'hostDetails.startupCommand.rules.expect.placeholder': 'Текст приглашения (пусто = отправить сразу, напр. password:)',
  'hostDetails.startupCommand.rules.send.placeholder': 'Текст для отправки (напр. ssh user@host)',
  'hostDetails.startupCommand.rules.add': 'Добавить правило',
  'hostDetails.startupCommand.rules.remove': 'Удалить правило',
