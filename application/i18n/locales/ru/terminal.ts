...
export const ruTerminalMessages: Messages = {
  ...
  'terminal.toolbar.leaveShare': 'Покинуть общий доступ',
  'terminal.toolbar.startShare': 'Начать общий доступ',
  'terminal.toolbar.stopShare': 'Остановить общий доступ',
  'terminal.toolbar.sharePin': 'PIN общего доступа {pin}',
  'terminal.toolbar.copiedPin': 'PIN скопирован',
  'terminal.toolbar.shareFrom': 'Через {name}',
  'terminal.share.starting': 'Запуск общего доступа…',
  'terminal.share.started': 'Общий доступ включён. PIN {pin}',
  'terminal.share.stopped': 'Общий доступ остановлен.',
  'terminal.share.ended': 'Общий сеанс завершён.',
  'terminal.share.startFailed': 'Не удалось начать общий доступ.',
  'terminal.share.joinFailed': 'Не удалось присоединиться к общему сеансу.',
  'terminal.share.copyFailed': 'Не удалось скопировать PIN.',
  'terminal.share.fileTransferUnsupported': 'Передача файлов недоступна в режиме ретрансляции.',
  'terminal.share.guestWriteBlocked': 'Гость может пользоваться только общим терминалом.',
  'terminal.share.sizeTitle': 'Размер общего терминала',
  'terminal.share.ptySize': 'PTY {cols}×{rows}',
  'terminal.share.sizeFromSelf': 'Используется ваш меньший размер',
  'terminal.share.sizeFromPeer': 'Используется меньший размер другой стороны',
  'terminal.share.sizeFromMixed': 'По каждой оси выбран меньший размер',
  'terminal.share.sizeMatched': 'Размеры совпадают {cols}×{rows}',
  'terminal.share.selfCapacity': 'Это окно {cols}×{rows}',
  'terminal.share.peerCapacity': 'Другая сторона {cols}×{rows}',
  'terminal.share.scaleToFit': 'Масштабировать на всё окно',
