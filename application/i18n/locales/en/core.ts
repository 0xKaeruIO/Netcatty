...
export const enCoreMessages: Messages = {
  ...
  // Settings > System > Organization Center
  'settings.orgCenter.title': 'Organization Center',
  'settings.orgCenter.hint': 'Add a Netcatty Center with its URL and API key. Hosts, passwords, and keys from the catalog appear in the vault so you can connect with one click.',
  'settings.orgCenter.url': 'Center URL',
  ...
  'settings.orgCenter.syncing': 'Syncing...',
  'settings.orgCenter.remove': 'Remove',
  'settings.orgCenter.removeConfirm': 'Remove "{name}" and its catalog hosts and groups from this device?',
  'settings.orgCenter.empty': 'No organization center added yet.',
  'settings.orgCenter.lastSynced': 'Last synced: {time}',
  'settings.orgCenter.neverSynced': 'Not synced yet',
  'settings.orgCenter.added': 'Added {name}',
  'settings.orgCenter.synced': 'Synced {name}',
  'settings.orgCenter.removed': 'Removed {name}',
  'settings.orgCenter.error.duplicate': 'This organization center is already added.',
  'settings.orgCenter.error.urlRequired': 'Organization center URL is required.',
  'settings.orgCenter.error.urlInvalid': 'Invalid organization center URL.',
  'settings.orgCenter.error.urlProtocol': 'Organization center URL must be http or https.',
...
`,
  ...
  'settings.appearance.terminalBackground': 'Terminal Background Image',
  'settings.appearance.terminalBackground.image': 'Background image',
  'settings.appearance.terminalBackground.image.desc': 'Painted behind the terminal grid in every session. The file is copied into Netcatty, so moving or deleting the original is safe.',
  'settings.appearance.terminalBackground.choose': 'Choose image',
  'settings.appearance.terminalBackground.replace': 'Replace',
  'settings.appearance.terminalBackground.remove': 'Remove',
  'settings.appearance.terminalBackground.pick': 'Select a terminal background image',
  'settings.appearance.terminalBackground.imageFilter': 'Images',
  'settings.appearance.terminalBackground.importFailed': 'Could not load the selected image.',
  'settings.appearance.terminalBackground.enabled': 'Show background image',
  'settings.appearance.terminalBackground.enabled.desc': 'Turn the wallpaper on for all terminal panes.',
  'settings.appearance.terminalBackground.opacity': 'Image opacity',
  'settings.appearance.terminalBackground.opacity.desc': 'How strongly the image blends over the terminal background color. Lower values keep text easier to read.',
  'settings.appearance.terminalBackground.fit': 'Fit mode',
  'settings.appearance.terminalBackground.fit.desc': 'How the image is scaled to the terminal viewport.',
  'settings.appearance.terminalBackground.fit.cover': 'Cover (fill, crop)',
  'settings.appearance.terminalBackground.fit.contain': 'Contain (fit inside)',
  'settings.appearance.terminalBackground.fit.stretch': 'Stretch to fill',
  'settings.appearance.terminalBackground.fit.tile': 'Tile',
  'settings.appearance.terminalBackground.fit.original': 'Original size',
  'settings.appearance.terminalBackground.position': 'Anchor',
  'settings.appearance.terminalBackground.position.desc': 'Where the image is anchored. Unavailable when stretching to fill.',
  'settings.appearance.terminalBackground.scale': 'Zoom',
  'settings.appearance.terminalBackground.scale.desc': 'Scales the image relative to its original size. Applies to tile and original size only.',
  'settings.appearance.terminalBackground.blur': 'Blur',
  'settings.appearance.terminalBackground.blur.desc': 'Softens the image so terminal text stays legible over busy photos.',
  ...
  'vault.groups.exportJson': 'Export group as JSON',
  ...
  'vault.orgCenter.cannotAddHost': 'Local hosts cannot be added to an organization group.',
  'vault.orgCenter.cannotMoveHost': 'Organization hosts cannot be moved.',
  'vault.orgCenter.cannotRenameRoot': 'The organization center root group cannot be renamed.',
  'vault.orgCenter.cannotUnparentGroup': 'Organization groups must stay under the organization center.',
  ...
  'vault.hosts.orgCenterSync': 'Sync',
  'vault.hosts.orgCenterSyncFrom': 'Pull from {name}',
  'vault.hosts.orgCenterEmpty': 'No organization center added yet.',
  'vault.hosts.orgCenterOpenSettings': 'Add in Settings',
  'vault.hosts.joinShare': 'Join share',
  'vault.hosts.joinSharePin': '6-digit PIN',
  'vault.hosts.joinSharePinInvalid': 'Enter the 6-digit share PIN.',
  'vault.hosts.joinShareSubmit': 'Join',
  'vault.hosts.newGroup': 'New Group',
  'vault.hosts.import': 'Import',
  'vault.hosts.export': 'Export CSV',
  'vault.hosts.exportJson': 'Export JSON',
  ...
  'vault.hosts.exportJson.toast.success': 'Exported {count} hosts to JSON',
  'vault.hosts.exportJson.toast.successWithSkipped': 'Exported {count} hosts to JSON ({skipped} unsupported hosts skipped)',
