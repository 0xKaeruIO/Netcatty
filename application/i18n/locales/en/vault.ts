...
export const enVaultMessages: Messages = {
  ...
  'notes.find.noResults': 'No results',
  'notes.find.matchCount': '{current} / {total}',
  'notes.find.prevMatch': 'Previous match (Shift+Enter)',
  'notes.find.nextMatch': 'Next match (Enter)',
  'notes.find.close': 'Close (Esc)',
  ...
  'hostDetails.os.title': 'Operating System',
  'hostDetails.os.desc': 'Used for environment reporting and shell-aware behavior.',
  ...
  'hostDetails.startupCommand.runMode.help': 'Choose how startup commands are sent after connection. Rule mode sends commands when prompt text is seen.',
  'hostDetails.startupCommand.runMode.lineDelay': 'Send line by line',
  'hostDetails.startupCommand.runMode.paste': 'Send all at once',
  'hostDetails.startupCommand.runMode.rules': 'Rule mode',
  'hostDetails.startupCommand.rules.help': 'When the prompt text appears, send the matching command. An empty prompt sends immediately. Add several rules to hop through hosts.',
  'hostDetails.startupCommand.rules.step': 'Step {n}',
  'hostDetails.startupCommand.rules.expect.placeholder': 'Prompt text (leave empty to send immediately, e.g. password:)',
  'hostDetails.startupCommand.rules.send.placeholder': 'Text to send (e.g. ssh user@host)',
  'hostDetails.startupCommand.rules.add': 'Add rule',
  'hostDetails.startupCommand.rules.remove': 'Remove rule',
