...
export const enTerminalMessages: Messages = {
  ...
  'terminal.toolbar.leaveShare': 'Leave share',
  'terminal.toolbar.startShare': 'Start sharing',
  'terminal.toolbar.stopShare': 'Stop sharing',
  'terminal.toolbar.sharePin': 'Share PIN {pin}',
  'terminal.toolbar.copiedPin': 'Copied share PIN',
  'terminal.toolbar.shareFrom': 'Share via {name}',
  'terminal.share.starting': 'Starting share…',
  'terminal.share.started': 'Sharing started. PIN {pin}',
  'terminal.share.stopped': 'Sharing stopped.',
  'terminal.share.ended': 'The shared session has ended.',
  'terminal.share.startFailed': 'Could not start sharing.',
  'terminal.share.joinFailed': 'Could not join the shared session.',
  'terminal.share.copyFailed': 'Could not copy the PIN.',
  'terminal.share.fileTransferUnsupported': 'File transfer is not supported in relay share mode.',
  'terminal.share.guestWriteBlocked': 'Guests can only use the shared terminal.',
  'terminal.share.sizeTitle': 'Shared terminal size',
  'terminal.share.ptySize': 'PTY {cols}×{rows}',
  'terminal.share.sizeFromSelf': 'Using your smaller size',
  'terminal.share.sizeFromPeer': 'Using the other side’s smaller size',
  'terminal.share.sizeFromMixed': 'Using the smaller size on each axis',
  'terminal.share.sizeMatched': 'Both sides match {cols}×{rows}',
  'terminal.share.selfCapacity': 'This window {cols}×{rows}',
  'terminal.share.peerCapacity': 'Other side {cols}×{rows}',
  'terminal.share.scaleToFit': 'Scale to fill window',
