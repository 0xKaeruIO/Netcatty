...
export const zhCNCoreMessages: Messages = {
  ...
  'settings.orgCenter.title': '组织中心',
  'settings.orgCenter.hint': '用地址和 API 密钥添加 Netcatty 组织中心。目录里的主机、密码和密钥会同步到保险库，点一下即可连接。',
  'settings.orgCenter.url': '中心地址',
  ...
  'settings.orgCenter.removeConfirm': '要从本机移除“{name}”及其目录主机和分组吗？',
  'settings.orgCenter.empty': '还没有添加组织中心。',
  'settings.orgCenter.lastSynced': '上次同步：{time}',
  'settings.orgCenter.neverSynced': '尚未同步',
  'settings.orgCenter.added': '已添加 {name}',
  'settings.orgCenter.synced': '已同步 {name}',
  'settings.orgCenter.removed': '已移除 {name}',
  'settings.orgCenter.error.duplicate': '这个组织中心已经添加过了。',
  'settings.orgCenter.error.urlRequired': '请填写组织中心地址。',
  'settings.orgCenter.error.urlInvalid': '组织中心地址无效。',
  'settings.orgCenter.error.urlProtocol': '组织中心地址必须是 http 或 https。',
...
`,
  ...
  'settings.appearance.terminalBackground': '终端背景图',
  'settings.appearance.terminalBackground.image': '背景图片',
  'settings.appearance.terminalBackground.image.desc': '绘制在所有终端会话的文字下方。图片会复制到 Netcatty 内部保存，之后移动或删除原文件都不受影响。',
  'settings.appearance.terminalBackground.choose': '选择图片',
  'settings.appearance.terminalBackground.replace': '更换',
  'settings.appearance.terminalBackground.remove': '移除',
  'settings.appearance.terminalBackground.pick': '选择终端背景图片',
  'settings.appearance.terminalBackground.imageFilter': '图片',
  'settings.appearance.terminalBackground.importFailed': '无法加载所选图片。',
  'settings.appearance.terminalBackground.enabled': '启用背景图',
  'settings.appearance.terminalBackground.enabled.desc': '在所有终端面板中显示背景图。',
  'settings.appearance.terminalBackground.opacity': '背景图透明度',
  'settings.appearance.terminalBackground.opacity.desc': '控制图片叠加在终端背景色上的浓淡。数值越低，终端文字越清晰。',
  'settings.appearance.terminalBackground.fit': '填充方式',
  'settings.appearance.terminalBackground.fit.desc': '图片如何缩放以适配终端可视区域。',
  'settings.appearance.terminalBackground.fit.cover': '覆盖（铺满并裁剪）',
  'settings.appearance.terminalBackground.fit.contain': '适应（完整显示）',
  'settings.appearance.terminalBackground.fit.stretch': '拉伸铺满',
  'settings.appearance.terminalBackground.fit.tile': '平铺',
  'settings.appearance.terminalBackground.fit.original': '原始尺寸',
  'settings.appearance.terminalBackground.position': '对齐位置',
  'settings.appearance.terminalBackground.position.desc': '图片的锚定位置。选择"拉伸铺满"时不可用。',
  'settings.appearance.terminalBackground.scale': '缩放',
  'settings.appearance.terminalBackground.scale.desc': '相对原始尺寸缩放图片，仅在"平铺"和"原始尺寸"下生效。',
  'settings.appearance.terminalBackground.blur': '模糊',
  'settings.appearance.terminalBackground.blur.desc': '虚化背景图，让终端文字在复杂图片上依然清晰可读。',
  ...
  'vault.groups.exportJson': '将组导出为 JSON',
  ...
  'vault.orgCenter.cannotAddHost': '不能把本地主机加入组织中心分组。',
  'vault.orgCenter.cannotMoveHost': '组织中心主机不能移动。',
  'vault.orgCenter.cannotRenameRoot': '组织中心根分组不能改名。',
  'vault.orgCenter.cannotUnparentGroup': '组织中心分组不能取消父分组。',
  ...
  'vault.hosts.orgCenterSyncFrom': '从 {name} 拉取',
  'vault.hosts.orgCenterEmpty': '尚未添加组织中心。',
  'vault.hosts.orgCenterOpenSettings': '前往设置添加',
  'vault.hosts.joinShare': '加入共享',
  'vault.hosts.joinSharePin': '6 位密码',
  'vault.hosts.joinSharePinInvalid': '请输入 6 位数字分享密码。',
  'vault.hosts.joinShareSubmit': '加入',
  'vault.hosts.newGroup': '新建分组',
  'vault.hosts.import': '导入',
  'vault.hosts.export': '导出 CSV',
  'vault.hosts.exportJson': '导出 JSON',
  ...
  'vault.hosts.exportJson.toast.success': '已导出 {count} 个主机到 JSON',
  'vault.hosts.exportJson.toast.successWithSkipped': '已导出 {count} 个主机到 JSON（跳过 {skipped} 个不支持的主机）',
  ...
  'vault.import.xshell.directoryHint': '请选择 Xshell 的 Sessions 文件夹。',
  'vault.import.xshell.chooseSource': '选择 Xshell 导入来源。',
  'vault.import.xshell.sourceQuestion': '你想导入哪些会话？',
  'vault.import.xshell.promptTitle': '从 Xshell 导入',
  'vault.import.xshell.promptDesc':
    '请选择 Xshell 的 Sessions 文件夹以导入全部会话并保留目录结构，也可以只导入单个 .xsh 会话文件。导入时会用当前 Windows 账户解密会话密码并保存为普通主机密码；Expect/Send 登录规则会转为启动命令规则。',
  'vault.import.xshell.folder': 'Sessions 文件夹',
  'vault.import.xshell.folderDesc': '一次导入全部会话，并保留目录结构。',
  'vault.import.xshell.file': '单个会话文件',
  'vault.import.xshell.fileDesc': '导入一个 Xshell .xsh 会话。',
  'vault.import.xshell.decryptHint': '导入时会用当前 Windows 账户解密会话密码，并保存为普通主机密码，之后可同步到其他机器。',
