...
export const zhCNTerminalMessages: Messages = {
  ...
  'terminal.toolbar.startShare': '开启分享',
  'terminal.toolbar.stopShare': '关闭分享',
  'terminal.toolbar.sharePin': '分享密码 {pin}',
  'terminal.toolbar.copiedPin': '已复制分享密码',
  'terminal.toolbar.shareFrom': '通过 {name} 分享',
  'terminal.toolbar.leaveShare': '离开共享',
  'terminal.share.starting': '正在开启分享…',
  'terminal.share.started': '已开启分享，密码 {pin}',
  'terminal.share.stopped': '已关闭分享。',
  'terminal.share.ended': '共享会话已结束。',
  'terminal.share.startFailed': '无法开启分享。',
  'terminal.share.joinFailed': '无法加入共享。',
  'terminal.share.copyFailed': '无法复制密码。',
  'terminal.share.fileTransferUnsupported': '中继分享模式下不支持传输文件。',
  'terminal.share.guestWriteBlocked': '访客只能操作这个共享终端。',
  'terminal.share.sizeTitle': '共享终端尺寸',
  'terminal.share.ptySize': 'PTY {cols}×{rows}',
  'terminal.share.sizeFromSelf': '已采用自己的较小尺寸',
  'terminal.share.sizeFromPeer': '已采用对方的较小尺寸',
  'terminal.share.sizeFromMixed': '列和行分别取了较小的一端',
  'terminal.share.sizeMatched': '两端尺寸一致 {cols}×{rows}',
  'terminal.share.selfCapacity': '当前窗口 {cols}×{rows}',
  'terminal.share.peerCapacity': '对方 {cols}×{rows}',
  'terminal.share.scaleToFit': '缩放以铺满窗口',
