...
export const zhCnSystemManagerMessages: Messages = {
  ...
  'systemManager.tabs.ports': '端口',
  'systemManager.tabs.services': '服务',
  ...
  'systemManager.errors.loadGpu': '加载 GPU / NPU 状态失败',
  ...
  'systemManager.ports.unavailable': '此主机未检测到端口工具（ss / netstat）。',
  'systemManager.ports.loading': '正在加载监听端口…',
  'systemManager.ports.empty': '暂无监听端口。',
  'systemManager.ports.search': '搜索端口…',
  'systemManager.ports.meta': '{{count}} 个监听',
  'systemManager.ports.filter.all': '全部',
  'systemManager.ports.unknownProcess': '未知进程',
  'systemManager.ports.terminate': '结束进程',
  'systemManager.ports.confirmTerminate': '向占用该端口的进程 {{pid}} 发送 SIGTERM？',

  'systemManager.services.unavailable': '此主机未检测到 systemctl。',
  'systemManager.services.loading': '正在加载 systemd 服务…',
  'systemManager.services.empty': '暂无 systemd 服务。',
  'systemManager.services.search': '搜索服务…',
  'systemManager.services.meta': '{{count}} 个服务',
  'systemManager.services.filter.all': '全部',
  'systemManager.services.filter.running': '运行中',
  'systemManager.services.filter.failed': '失败',
  'systemManager.services.filter.inactive': '未运行',
  'systemManager.services.start': '启动',
  'systemManager.services.stop': '停止',
  'systemManager.services.restart': '重启',
  'systemManager.services.enable': '开机启用',
  'systemManager.services.disable': '禁用开机',
  'systemManager.services.reload': '重载',
  'systemManager.services.scope.user': '用户',
  'systemManager.services.confirmAction': '确认对 {{name}} 执行「{{action}}」？',

  'systemManager.gpu.unavailable': '此主机未检测到 NVIDIA GPU 或昇腾 NPU 工具。',
  'systemManager.gpu.loading': '正在加载加速卡状态…',
  'systemManager.gpu.empty': '已检测到加速卡工具，但未返回设备信息。',
  'systemManager.gpu.meta': '{{devices}} 张卡 · {{processes}} 个进程',
  'systemManager.gpu.devices': '设备',
  'systemManager.gpu.processes': '计算进程',
  'systemManager.gpu.noProcesses': '当前没有计算进程。',
  'systemManager.gpu.vendor.nvidia': 'NVIDIA',
  'systemManager.gpu.vendor.ascend': '昇腾',
  'systemManager.gpu.util': '利用率',
  'systemManager.gpu.memory': '显存',
  'systemManager.gpu.hbm': 'HBM',
  'systemManager.gpu.temperature': '温度',
