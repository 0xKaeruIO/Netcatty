...
export const zhCNVaultMessages: Messages = {
  ...
  'notes.find.noResults': '无结果',
  'notes.find.matchCount': '{current} / {total}',
  'notes.find.prevMatch': '上一个匹配 (Shift+Enter)',
  'notes.find.nextMatch': '下一个匹配 (Enter)',
  'notes.find.close': '关闭 (Esc)',
  ...
  'hostDetails.os.title': '操作系统',
  'hostDetails.os.desc': '用于环境信息和适配对应的命令行行为。',
  ...
  'hostDetails.startupCommand.runMode.help': '选择连接后如何发送启动命令。规则模式会按提示字符串依次发送。',
  'hostDetails.startupCommand.runMode.lineDelay': '逐行发送',
  'hostDetails.startupCommand.runMode.paste': '一次性发送',
  'hostDetails.startupCommand.runMode.rules': '规则模式',
  'hostDetails.startupCommand.rules.help': '监听到提示字符串后自动发送对应内容。提示为空则立即发送。可添加多条连续规则，用于跳转登录。',
  'hostDetails.startupCommand.rules.step': '第 {n} 步',
  'hostDetails.startupCommand.rules.expect.placeholder': '提示字符串（留空则立即发送，例如 password:）',
  'hostDetails.startupCommand.rules.send.placeholder': '发送内容（例如 ssh user@host）',
  'hostDetails.startupCommand.rules.add': '添加规则',
  'hostDetails.startupCommand.rules.remove': '删除规则',
  ...
  'cloudSync.provider.disconnect': '断开连接',
  'cloudSync.provider.disconnect.confirmTitle': '断开 “{name}”？',
  'cloudSync.provider.disconnect.confirmMessage': '此设备将停止与 {name} 同步。本地保险库仍保留在这台电脑上。',
  'cloudSync.provider.disconnect.confirmAction': '断开连接',
  ...
  'pf.action.startAll': '全部启动',
  'pf.action.stopAll': '全部停止',
  'pf.toast.startAll.success': '已启动 {count} 条规则',
  'pf.toast.startAll.partial': '已启动 {started} 条规则（{failed} 条失败）',
  'pf.toast.startAll.failed': '启动失败 {count} 条规则',
  'pf.toast.stopAll.success': '已停止 {count} 条隧道',
  'pf.toast.stopAll.partial': '已停止 {stopped} 条隧道（{failed} 条失败）',
  'pf.toast.stopAll.failed': '停止失败 {count} 条隧道',
  'pf.view.grid': '网格',
  'pf.view.list': '列表',
