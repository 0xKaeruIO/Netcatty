...
function createPreloadApi(ctx) {
  ...
  orgCenterHealth: (url, skipTlsVerify) => ipcRenderer.invoke("netcatty:orgCenter:health", { url, skipTlsVerify }),
  orgCenterFetchCatalog: (url, apiKey, skipTlsVerify) => ipcRenderer.invoke("netcatty:orgCenter:fetchCatalog", { url, apiKey, skipTlsVerify }),
