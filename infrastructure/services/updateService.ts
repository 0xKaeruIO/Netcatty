...
const GITHUB_API_URL = 'https://api.github.com/repos/0xKaeruIO/Netcatty/releases/latest';
const RELEASES_PAGE_URL = 'https://github.com/0xKaeruIO/Netcatty/releases';
